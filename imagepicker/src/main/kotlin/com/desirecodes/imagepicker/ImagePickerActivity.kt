...
import com.desirecodes.imagepicker.provider.CameraProvider
import com.desirecodes.imagepicker.provider.CompressionProvider
import com.desirecodes.imagepicker.provider.CropProvider
import com.desirecodes.imagepicker.provider.GalleryProvider
import com.desirecodes.imagepicker.util.FileUriUtils

/**
 * Pick Image
 *
 * @author Dhaval Patel
 * @updated Tharindu Dhanushke
 * @version 1.0
...
class ImagePickerActivity : AppCompatActivity() {
     ...
     */
    fun setImage(uri: Uri, isLauncher: Boolean=false) {
        when {
            mCropProvider.isCropEnabled() -> mCropProvider.startIntent(uri,isLauncher)
