...
import com.desirecodes.imagepicker.util.ExifDataCopier
import com.desirecodes.imagepicker.util.FileUtil
import com.desirecodes.imagepicker.util.ImageUtil
import java.io.File
        ...
        object : AsyncTask<Uri, Void, File>() {
            ...
            override fun onPostExecute(file: File?) {
                ...
                if (file != null) {
                    ...
                    // Post Error
                    setError(com.desirecodes.imagepicker.R.string.error_failed_to_compress_image)
                }
            }
        }.execute(uri)
    }
